...
const PUBLIC_WAREHOUSE_DATA = {
  ...
  yearlyInventory: {
    ...
    w1Begin: [328, 348, 365, 388, 402, 412, 445, 462, 471],
    w1End: [348, 365, 388, 402, 412, 445, 462, 471, 484],
    w2Begin: [198, 212, 228, 248, 262, 278, 296, 312, 326],
    w2End: [212, 228, 248, 262, 278, 296, 312, 326, 338],
  },
  ...
  inbound: {
    ...
    yearlyTotal: {
      count: {
        labels: ['2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024', '2025'],
        total: [228, 245, 258, 265, 272, 280, 310, 310, 86],
        w1: [138, 148, 156, 161, 165, 170, 188, 188, 52],
        w2: [90, 97, 102, 104, 107, 110, 122, 122, 34],
      },
      quantity: {
        labels: ['2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024', '2025'],
        total: [1180, 1260, 1340, 1380, 1400, 1420, 1580, 1540, 423],
        w1: [715, 765, 815, 838, 850, 860, 958, 933, 256],
        w2: [465, 495, 525, 542, 550, 560, 622, 607, 167],
      },
      assetValue: {
        labels: ['2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024', '2025'],
        total: [1820, 1920, 2010, 2050, 2080, 2100, 2280, 2193, 573],
        w1: [1100, 1160, 1220, 1245, 1260, 1270, 1380, 1330, 348],
        w2: [720, 760, 790, 805, 820, 830, 900, 863, 225],
      },
    },
  ...
  outbound: {
    ...
    yearlyTotal: {
      count: {
        labels: ['2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024', '2025'],
        total: [218, 232, 245, 252, 258, 265, 290, 293, 79],
        w1: [132, 141, 148, 153, 157, 161, 176, 177, 48],
        w2: [86, 91, 97, 99, 101, 104, 114, 116, 31],
      },
      quantity: {
        labels: ['2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024', '2025'],
        total: [1120, 1200, 1280, 1320, 1350, 1380, 1520, 1525, 423],
        w1: [680, 728, 778, 802, 820, 838, 924, 925, 257],
        w2: [440, 472, 502, 518, 530, 542, 596, 600, 166],
      },
      savedFunds: {
        labels: ['2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024', '2025'],
        total: [310, 340, 360, 370, 375, 380, 420, 426, 128],
        w1: [188, 207, 219, 225, 228, 232, 256, 260, 78],
        w2: [122, 133, 141, 145, 147, 148, 164, 166, 50],
      },
    },
    currentYearQuarterly: {
