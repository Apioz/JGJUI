const MIDDLE_PLATFORM_MODULES = {
  ...
  fireAlarmList: {
    ...
    filters: {
      processStatus: { label: '流程状态', placeholder: '请选择流程状态', options: ['未处理', '误报', '测试', '确认火警', '确认故障', '复位'] },
      alarmLevel: { label: '报警等级', placeholder: '请选择报警等级', options: ['疑似火警', '一级报警', '二级报警', '三级报警'] },
    ...
    table: {
      ...
      rows: [
        ...
        { index: 2, deviceName: 'BJ20250626002', deviceType: '火焰探测器', system: 'FLAME-101W', location: '生物芯片1号楼102室西侧天花板', alarmLevel: '一级报警', alarmDesc: '报警触发', alarmType: '自动上传', processStatus: '确认报警', processNote: '描述', startTime: '2025-06-26 15:48:39', endTime: '2025-06-26 15:48:39' },
        { index: 3, deviceName: 'BJ20250626003', deviceType: '火焰探测器', system: 'FLAME-101W', location: '生物芯片1号楼103室西侧天花板', alarmLevel: '一级报警', alarmDesc: '报警触发', alarmType: '自动上传', processStatus: '确认火警', processNote: '描述', startTime: '2025-06-26 15:48:39', endTime: '2025-06-26 15:48:39' },
        { index: 4, deviceName: 'BJ20250626004', deviceType: '火焰探测器', system: 'FLAME-101W', location: '生物芯片1号楼104室西侧天花板', alarmLevel: '一级报警', alarmDesc: '报警触发', alarmType: '自动上传', processStatus: '未处理', processNote: '描述', startTime: '2025-06-26 15:48:39', endTime: '2025-06-26 15:48:39' },
        ...
        { index: 7, deviceName: 'BJ20250626007', deviceType: '火焰探测器', system: 'FLAME-101W', location: '生物芯片1号楼107室西侧天花板', alarmLevel: '二级报警', alarmDesc: '报警触发', alarmType: '自动上传', processStatus: '未处理', processNote: '描述', startTime: '2025-06-26 14:30:00', endTime: '2025-06-26 14:30:00' },
        { index: 8, deviceName: 'BJ20250626008', deviceType: '感烟火灾探测器', system: 'SMOKE-201', location: '生物芯片2号楼201室', alarmLevel: '一级报警', alarmDesc: '报警触发', alarmType: '自动上传', processStatus: '确认火警', processNote: '描述', startTime: '2025-06-26 13:15:00', endTime: '2025-06-26 13:20:00' },
        { index: 9, deviceName: 'BJ20250626009', deviceType: '感烟火灾探测器', system: 'SMOKE-201', location: '生物芯片2号楼202室', alarmLevel: '二级报警', alarmDesc: '报警触发', alarmType: '自动上传', processStatus: '复位', processNote: '描述', startTime: '2025-06-26 12:00:00', endTime: '2025-06-26 12:05:00' },
        { index: 10, deviceName: 'BJ20250626010', deviceType: '手动报警按钮', system: 'MANUAL-301', location: '生物芯片3号楼1层大厅', alarmLevel: '一级报警', alarmDesc: '报警触发', alarmType: '手动上报', processStatus: '未处理', processNote: '描述', startTime: '2025-06-26 11:00:00', endTime: '2025-06-26 11:00:00' },
      ],
      total: 200,
      pageSize: 10,
    },
  ...
  fireFaultList: {
    ...
    filters: {
      processStatus: { label: '流程状态', placeholder: '请选择流程状态', options: ['未处理', '处理中', '已处理', '误报', '测试', '复位'] },
    ...
    table: {
      ...
      rows: [
        ...
        { index: 2, deviceName: '生物芯片1号楼102', deviceType: '用户终端', system: '防排烟系统', location: '生物芯片1号楼102室', faultLevel: '紧急故障', faultDesc: '描述', faultType: '误报', processStatus: '处理中', processNote: '说明', startTime: '2025/5/13 12:00', endTime: '2025/6/16 12:00' },
        { index: 3, deviceName: '生物芯片1号楼103', deviceType: '水柜', system: '自动喷水灭火系统', location: '生物芯片1号楼103室', faultLevel: '紧急故障', faultDesc: '描述', faultType: '测试', processStatus: '已处理', processNote: '说明', startTime: '2025/5/14 12:00', endTime: '2025/6/17 12:00' },
        ...
        { index: 5, deviceName: '生物芯片1号楼105', deviceType: '无线压力传感器', system: '室内消火栓系统', location: '生物芯片1号楼105室', faultLevel: '紧急故障', faultDesc: '描述', faultType: '确认火警', processStatus: '处理中', processNote: '说明', startTime: '2025/5/16 12:00', endTime: '2025/6/19 12:00' },
        { index: 6, deviceName: '生物芯片1号楼106', deviceType: '智慧用电', system: '电气火灾系统', location: '生物芯片1号楼106室', faultLevel: '紧急故障', faultDesc: '描述', faultType: '复位', processStatus: '已处理', processNote: '说明', startTime: '2025/5/17 12:00', endTime: '2025/6/20 12:00' },
        ...
        { index: 8, deviceName: '生物芯片1号楼108', deviceType: '无线液位仪', system: '室内消火栓系统', location: '生物芯片1号楼108室', faultLevel: '紧急故障', faultDesc: '描述', faultType: '误报', processStatus: '处理中', processNote: '说明', startTime: '2025/5/19 12:00', endTime: '2025/6/22 12:00' },
        { index: 9, deviceName: '生物芯片1号楼109', deviceType: '火警设备探测器', system: '火灾自动报警系统', location: '生物芯片1号楼109室', faultLevel: '紧急故障', faultDesc: '描述', faultType: '测试', processStatus: '已处理', processNote: '说明', startTime: '2025/5/20 12:00', endTime: '2025/6/23 12:00' },
